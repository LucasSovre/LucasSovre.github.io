...
export default function Welcome() {
	function disapear() {
		...
		for (var i = 0; i < reveals.length; i++) {
			...
			if (elementTop < -450) {
				...
				document
					.getElementById("HD-main")
					.classList.remove("HD-scrolled");
			}
		}
	}
	...
	function umamiTrackMainContact() {
		umami.trackEvent(
			"Contact button welcome component click",
			"contact main"
		);
	}
		...
		<div id="WL-main">
			<div id="WL-text">
				<div style={{ display: "flex", flexDirection: "column" }}>
					...
					{langage === "en" ? (
						<h3>
							I am an informatic engineer specialised in software,
							informatic architecure and web technologies
						</h3>
					) : (
						<h3>
							Je suis un ingénieur informatique spécialisé en
							developpement logicielle, architecure informatique
							et technologies web.
						</h3>
					)}
					{langage === "en" ? (
						<a
							href="mailto:lucas.sovre@yahoo.com"
							onClick={() => {
								umamiTrackMainContact();
							}}>
							Contact
						</a>
					) : (
